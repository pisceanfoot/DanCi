...
var bingDict = {
  query: async function (arg) {
    ...
    const result = await chrome.runtime.sendMessage({
      type: "http_get",
      url: `https://cn.bing.com/dict/search?q=${encodeURIComponent(arg.word)}`,
    });

    console.log("translation result", result);
    if (!result) {
      console.error("fail to get translation");
      return;
    }
    ...
    var obj = bingDict._parseHtml(result.data);
    arg.callback(obj);
  },
